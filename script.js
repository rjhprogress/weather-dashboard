...
function getForecast(searchValue) {
  $.ajax({
    type: "GET",
    url: "http://api.openweathermap.org/data/2.5/forecast?q=" + searchValue + "&appid=5d32c3c46f4249ead84cbc22d3498938&units=imperial",
    dataType: "json",
    success: function(data) {
...
function getUVIndex(lat, lon) {
  $.ajax({
    type: "GET",
    url: "http://api.openweathermap.org/data/2.5/uvi?appid=5d32c3c46f4249ead84cbc22d3498938&lat=" + lat + "&lon=" + lon,
    dataType: "json",
    success: function(data) {
